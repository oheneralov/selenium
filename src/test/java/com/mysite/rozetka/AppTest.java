...
public class AppTest extends TestCase {
	...
	public void testRozetkaexport() {
		...
		(new Actions(driver)).contextClick( driver.findElement(By.cssSelector("span")));
		...
		System.out.printf("The laguage is: %s",
				driver.findElement(By.cssSelector("span.lang-switcher-link.gray")).getText());
		...
		assertEquals("Корзина", driver.findElement(By.xpath(
				"//a[@onclick=\"document.fireEvent('openCart', {extend_event: [{name: 'eventLocation', value: 'Head'}]});\"]"))
				.getText());
